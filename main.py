...
page2 = st.Page("pages/detection_limit.py", title="Detection Limit", icon=":material/sensors:")
page3 = st.Page("pages/model_type.py", title="Model Type", icon=":material/radar:")
page4 = st.Page("pages/dynamic_range.py", title="Dynamic Range", icon=":material/arrow_range:")
